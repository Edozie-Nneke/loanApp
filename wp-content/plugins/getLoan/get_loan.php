      ...
      <form @submit.prevent="getLoan();">
        <div class="row my-3">
          <div class="col">
            ...
            <input x-model="customer_bvn" type="number" class="form-control" id="customer_bvn" placeholder="10101010101" />
          </div>
        </div>
        ...
        <div class="row my-3">
          <div class="col">
            ...
            <input x-model="customer_tel" type="tel" class="form-control" id="customer_tel" placeholder="0801 234 5678" />
          </div>
        </div>
        ...
        <div class="row my-3">
          ...
          <div class="col input-group">
            ...
            <input x-model="loan_amount" type="number" class="form-control" id="loan_amount" placeholder="" />
          </div>
        </div>

        <div class="row my-4">
          <div class="col">
            <button x-text="isComplete ? 'Submit' : 'Continue'" x-bind:type="isComplete ? 'submit' : 'button'" class="btn btn-success"></button>
          </div>
        </div>
      </form>
    </section>
